...
//  Tipster
//
//  Created by unauthorize on 6/25/19.
...
- (IBAction)onEditBegin:(id)sender {
    self.billField.frame = CGRectMake(self.billField.frame.origin.x, self.billField.frame.origin.y + 30, self.billField.frame.size.width,
...
- (IBAction)onEditEnd:(id)sender {
    CGRect newFrame = self.billField.frame; newFrame.origin.y -= 30;
